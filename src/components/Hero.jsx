...
export default function Hero({ skills }) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-screen-2xl px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-slate-900 dark:text-slate-100">
            Hi, I'm{" "}
          ...
          <div className="mt-8 flex gap-6 ml-[20%]">
            <a
              href="#projects"
              className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-100 to-cyan-200 text-black font-semibold shadow-lg hover:scale-105 hover:from-blue-200 hover:to-cyan-300 transition-transform dark:bg-gradient-to-r dark:from-indigo-700 dark:to-purple-700 dark:text-white"
            >
              🚀 View Projects
            </a>
            ...
            <a
              href="#contact"
              className="px-6 py-2.5 rounded-xl border border-blue-500 text-blue-600 hover:bg-blue-50 shadow font-semibold dark:border-indigo-400 dark:text-indigo-300 dark:hover:bg-indigo-800/40"
            >
              ✉️ Get in Touch
            </a>
          </div>

          <div className="mt-8 flex items-center gap-5 text-slate-600 dark:text-slate-300 ml-[40%]">
        ...
        {/* Right Column */}
        <motion.div
          className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/30 dark:border-slate-700"
